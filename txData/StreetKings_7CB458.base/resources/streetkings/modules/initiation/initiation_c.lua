...
local SPAWN_POSITIONS = {
    ...
    { x = -383.8696, y = 276.2479, z = 84.1597, h = 11.3386 },
}
...
local CAM_LOOK_AT = {
    x = (SPAWN_POSITIONS[1].x + SPAWN_POSITIONS[2].x + SPAWN_POSITIONS[3].x + SPAWN_POSITIONS[4].x) / 4,
    y = (SPAWN_POSITIONS[1].y + SPAWN_POSITIONS[2].y + SPAWN_POSITIONS[3].y + SPAWN_POSITIONS[4].y) / 4,
    z = (SPAWN_POSITIONS[1].z + SPAWN_POSITIONS[2].z + SPAWN_POSITIONS[3].z + SPAWN_POSITIONS[4].z) / 4 + 1.0,
}
