...
SKMessageDefs = {
    hector_welcome = {
        ...
        body   = [[Welcome to NZ Cars and Coffee. Out here your real opponent is the clock - new track rotation drops every day. Post your times, stack the cash and the XP.
