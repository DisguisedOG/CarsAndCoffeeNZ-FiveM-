...
If you downloaded this from somewhere else, I am not responsible for any problems related to that.
...
Drag the 'aq61subfa20' folder into GTAV/mods/update/x64/dlcpacks
Edit the dlclist.xml in GTAV/mods/update/update.rpf/common/data
Add the following line - <Item>dlcpacks:/aq61subfa20/</Item>


Installation (FiveM);

Drag the 'aq61subfa20' folder into your 'resource' folder. OR, you can install this on top of an existing sound resource.
...
To use on any car, edit the vehicles.meta it is defined in, and replace this line with;
<audioNameHash>aq61subfa20</audioNameHash>
